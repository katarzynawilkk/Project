...
class Db_executer(Database):
    ...
    def create_analysis_table(self):
        ...
        try:
            ...
            logger.error(f"Can nt create table analysis {e}")
    ...
    def hospital_analysis(self):
        try:
            with open(r"C:\Users\Kasia\PycharmProjects\W1_cwiczenia\Project\Hospital.csv", encoding="UTF8") as csv_hospital:
